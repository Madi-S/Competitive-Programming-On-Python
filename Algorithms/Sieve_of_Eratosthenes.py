...
# We keep doing this until our step (not step * 2) becomes more than square root of last number. E.g.: list up to 300 nums, we stop looping when step hits 18 because 10*19 > 300
